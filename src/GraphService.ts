...
import { User, Event, Chat } from 'microsoft-graph';
...
export async function getChat(authProvider: AuthCodeMSALBrowserAuthenticationProvider): Promise<Chat> {
    ensureClient(authProvider);

    // Return the /me API endpoint result as chat messages object
    var chat: Chat = await graphClient!.api('/me/chats/19:2b79e2e5115944c5a4b653a6e2881f0d@thread.v2')
        .get();
